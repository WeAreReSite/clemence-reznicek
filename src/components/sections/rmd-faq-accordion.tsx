...
interface RMDFAQAccordionItemProps {
  question: string;
  answer: string;
  isOpen: boolean;
  onToggle: () => void;
...
interface RMDFAQAccordionProps {
  items: FAQItem[];
}

export function RMDFAQAccordion({ items }: RMDFAQAccordionProps) {
